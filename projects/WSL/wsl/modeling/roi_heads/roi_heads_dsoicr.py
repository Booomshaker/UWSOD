...
from wsl.modeling.roi_heads.fast_rcnn_dsmil import DSMILOutputLayers
from wsl.modeling.roi_heads.fast_rcnn_dsoicr import DSOICROutputLayers
...
class DSOICRROIHeads(ROIHeads):
    ...
    def _init_box_head(cls, cfg, input_shape):
        ...
        for k in range(refine_K):
            box_refinery_k = DSOICROutputLayers(cfg, box_head.output_shape, k)
